...
class TagPicker extends Component {
  ...
  render() {
    ...
    const { closable, className, style, tagClassName = `${styles.tagSelect} m-tag-small`, allTagData = {}, rowKey = 'id', titleKey = 'name', label = '', dataSource = [], value = valueInstate, expand = expandInstate, tagType } = this.props;
    // 处理样式
