...
class SettingContent extends React.Component {
    state={
      themesData: [
        ...
        //   darkSideTheme: [
        //     {
        //       key: 'default-darkColor-theme',
        //       title: '中国红彩色',
        //     },
        //     {
        //       key: 'blue-grayColor-theme',
        //       title: '灰蓝彩色',
        //     },
        //     {
        //       key: 'blue-darkDolor-theme',
        //       title: '晴空蓝彩色',
        //     },
        //     {
        //       key: 'blue-techColor-theme',
        //       title: '科技蓝彩色',
        //     },
        //   ],
        // },
    ...
    render() {
      const { themesData, themesData: { darkSideTheme, fullColorTheme } } = this.state;
      const { theme } = this.props;
      return (
        <div>
