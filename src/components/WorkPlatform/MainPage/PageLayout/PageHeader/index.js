...
class PageHeader extends React.PureComponent {
  ...
  styleFcn = () => {
    const { menuTree = [], menuShow, width, collapsed } = this.props;
    let style = '';
  ...
  render() {
    const { style = {}, width, collapsed } = this.props;
          ...
          (
            <Row>
              <Logo
                {...this.props}
              />
              {/* <div className="left" style={{ display: `${width < 1280 ? 'none' : 'block'}` }}>
                <TopMenu location={location} {...this.props} />
              </div> */}
