...
import { FetchSearchExistingCustomer } from '../../../../../services/home/home';
import { HighLightKeyword } from '../../../../Common/TextHandler/HtmlToText';
    ...
    return (
      <div id="SearchInput_pageheader" style={{ width: '100%' }}>
        ...
        >
          <Input
            onClick={() =>
              this.handleAutoCompleteOnClick(fillValue, isFirstSearch)
            }
            suffix={
              fillValue ? (
                <i className="iconfont icon-icon-search" />
              ) : (
                <i className="iconfont icon-icon-search" />
              )
            }
