...
// import logoSmall from '../../../../assets/logo-htsW.png';
...
class MainPageLayout extends React.PureComponent {
  ...
  componentDidMount() {
    ...
    if (isNotSSO && isNotLoading && isNotIndex && beforeSsoLoginUrl) {
      ...
      // history.push(beforeSsoLoginUrl);
  ...
  render() {
    ...
    console.log(menuTree, menuTreeLoaded, '_________________________menu', routes);
    ...
    const meunObjData = width < 1280 ? menuTree : subMenuTree;
    let situation = 'pc';
