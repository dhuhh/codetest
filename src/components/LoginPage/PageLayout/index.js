...
class LoginPageLayout extends React.PureComponent {
  ...
  fetchData = () => {
    ...
    FetchQryLoginPageConf({}).then((ret = {}) => {
      ...
      if (code > 0) {
        ...
        console.log(captcha, 'cccccccccccccccccccccccccccccc');
        this.setState({
          captcha,
          copyright,
        });
  ...
  componentDidMount() {
    ...
    const applicationName =
      localStorage.getItem('applicationName') || '产品中心';
          ...
          <div className="m-layout-content-box">
            ...
            <div className="m-layout-content-box-item">
              <div className="m-item-info">
                {/* <h2 >股票质押项目管理系统</h2> */}
                {/* <p>
                  大数据  微服务 智能化<br /> 线上线下全面融合构建业务生态圈<br /> 全新客户画像，全新业务场景、全新MOT<br />  全新互联网交互界面
                </p> */}
              </div>
